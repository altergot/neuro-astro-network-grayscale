...
if i == 1
    ...
    Iapp = image .* (params.max_Iapp_test - params.min_Iapp_test) + params.min_Iapp_test;
...
elseif i == 3
    ...
    Iapp = image .* (params.max_Iapp_noise - params.min_Iapp_noise) + params.min_Iapp_noise;
...
elseif i == 4
    ...
    image = 255 - shiftdim(image(:,:,1));
    image = double(image);
    Iapp = image ./ 255 .* (params.max_Iapp_test - params.min_Iapp_test) + params.min_Iapp_test;
end
